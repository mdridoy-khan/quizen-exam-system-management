...
const PresidentEvents = () => {
  ...
  return (
    <div className="dashboard_content">
      {/* Header - Always Visible - No Matter What */}
      <div className="flex flex-col md:flex-row items-center justify-between mb-8 gap-6">
        <div className="text-center md:text-left">
          ...
          <p className="text-lg text-gray600">
            Total Events: {loading ? "..." : count}
          </p>
        </div>

        <Link
          to="/president/event-creation-form"
        ...
        >
          CREATE EVENT <LuCirclePlus size={20} />
        </Link>
      </div>
      ...
      {loading && (
        <div className="flex flex-col items-center justify-center py-20">
          ...
          <p className="text-gray600 text-lg">Loading events...</p>
        </div>
      )}
      ...
      {error && !loading && (
        <div className="flex flex-col items-center justify-center py-16 text-center">
          <img src={ErrorImage} alt="Error" className="w-72 opacity-80" />
      ...
      {!loading && !error && announcements.length === 0 && (
        <div className="flex flex-col items-center justify-center py-20 text-center">
          <img src={ErrorImage} alt="No events" className="w-80" />
          <h3 className="text-2xl font-bold text-gray700 mb-3">
            No Events Found
          </h3>
          <p className="text-gray500 max-w-md">
            There are no events yet. Click the button above to create your first
            event!
          </p>
        </div>
      )}

      {/* Events Grid - Only if data exists */}
      {!loading && !error && announcements.length > 0 && (
        <>
            ...
            {announcements.map((ann) => (
              <div key={ann.id}>
                ...
                <div className="flex flex-wrap gap-2 mt-3">
                  <Link
                    to={`/president/all-rounds/${ann.id}`}
          ...
          {/* <div className="flex flex-col items-center gap-4 mt-10">
            <div className="flex items-center gap-2 flex-wrap justify-center">
              <button
                onClick={() => prevPageUrl && fetchAnnouncements(prevPageUrl)}
                disabled={!prevPageUrl || loading}
                className="px-6 py-2.5 rounded-full font-semibold text-white bg-secondary disabled:opacity-50 hover:scale-105 transition"
              >
                Previous
              </button>
              ...
              <button
                onClick={() => nextPageUrl && fetchAnnouncements(nextPageUrl)}
...
//           >
//             CREATE EVENT <LuCirclePlus size={18} />
//           </Link>
//         </div>
//       </div>

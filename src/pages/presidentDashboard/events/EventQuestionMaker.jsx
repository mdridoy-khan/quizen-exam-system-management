...
const EventQuestionMaker = () => {
  ...
  const [negativePerQuestion, setNegativePerQuestion] = useState(0); // New state for negative marking
  const [markPerQuestion, setMarkPerQuestion] = useState(1); // New state for mark per question
  ...
  async function handleQuizQuestionSave() {
    try {
      ...
      const payload = {
        quiz_prompt: prompt,
        quiz_link: link,
        negative_per_question: negativePerQuestion, // Added to payload
        mark_per_question: markPerQuestion, // Added to payload
  ...
  const handleNegativePerQuestionChange = (e) => {
    const value = e.target.value;
    if (value === "") {
      setNegativePerQuestion("");
      return;
    }
    const number = parseFloat(value);
    if (number >= 0) {
      setNegativePerQuestion(number);
    }
  };

  const handleMarkPerQuestionChange = (e) => {
    const value = e.target.value;
    if (value === "") {
      setMarkPerQuestion("");
      return;
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await API.post(
        "/qzz/president-ai-json-response/",
        formData,
        {
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
              ...
              <div>
                ...
                <input
                  ...
                  min={1}
                  step="0.1"
                  onChange={handleMarkPerQuestionChange}
                  className="w-full px-3 py-2 border border-gray300 rounded-lg focus:ring-1 focus:ring-primary focus:border-primary transition outline-none shadow-none"
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  min={0}
                  step="0.1"
                  onChange={handleNegativePerQuestionChange}
                  className="w-full px-3 py-2 border border-gray300 rounded-lg focus:ring-1 focus:ring-primary focus:border-primary transition outline-none shadow-none"
                />
              </div>
            </div>
          ...
          <div className="bg-white rounded-xl shadow-xl max-w-2xl w-full max-h-[90vh] overflow-hidden">
            ...
            <div className="p-6 overflow-y-auto max-h-[calc(90vh-180px)]">
              <div className="space-y-4">
                ...
                <div className="flex justify-between items-center py-3 border-b border-gray100">
                  <span className="text-gray600">Mark per Question</span>
                  <span className="font-medium">{markPerQuestion}</span>
                </div>
                ...
                <div className="flex justify-between items-center py-3 border-b border-gray100">
                  ...
                  <span className="font-medium">{negativePerQuestion}</span>
                </div>
...
export default EventQuestionMaker;
